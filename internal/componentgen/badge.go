...
func BadgeSource() Source {
	return Source{
		...
		Props: []Prop{
			{
				Name: "text", GoName: "Text", Type: "string",
		...
		Examples: []Example{
			{
				Name:      "default",
				Canonical: true,
				Props:     map[string]any{"text": "Active", "variant": "default"},
			},
			{
				Name:  "success",
				Props: map[string]any{"text": "Published", "variant": "success", "dot": true},
			},
		},
	}
}
...
func BadgeWebStyle() WebStyle {
	return WebStyle{
		...
		Variants: map[string][]Utility{
			...
			"success": {
				{Method: "Bg", Arg: "SurfaceSuccessSoft"},
				{Method: "TextColor", Arg: "FgSuccess"},
			},
			"warning": {
				{Method: "Bg", Arg: "SurfaceWarningSoft"},
				{Method: "TextColor", Arg: "FgWarning"},
			},
			"error": {
				{Method: "Bg", Arg: "SurfaceDangerSoft"},
				{Method: "TextColor", Arg: "FgDanger"},
			},
			"danger": {
				{Method: "Bg", Arg: "SurfaceDangerSoft"},
				{Method: "TextColor", Arg: "FgDanger"},
			...
			"info": {
				{Method: "Bg", Arg: "SurfaceInfoSoft"},
				{Method: "TextColor", Arg: "FgInfo"},
			},
		},
		...
		Body: []Step{
			...
			{Kind: StepText, Prop: "Text", Part: "Label", Fallback: "Active"},
		},
	}
}
